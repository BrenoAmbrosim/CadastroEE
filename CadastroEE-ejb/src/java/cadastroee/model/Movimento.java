...
@NamedQueries({
    ...
    @NamedQuery(name = "Movimento.findByFKPessoaidPessoa", query = "SELECT m FROM Movimento m WHERE m.fKPessoaidPessoa = :fKPessoaidPessoa"),
...
public class Movimento implements Serializable {
    ...
    public Movimento(Integer idMovimento, int fKPessoaidPessoa) {
        this.idMovimento = idMovimento;
    ...
    public int getFKPessoaidPessoa() {
        return fKPessoaidPessoa;
    }

    public void setFKPessoaidPessoa(int fKPessoaidPessoa) {
        this.fKPessoaidPessoa = fKPessoaidPessoa;
    }
